...
\institute{Center for Astrophysics \,$|$\, Harvard \& Smithsonian \\[4pt]
           \Large Mentors: Asst.\ Prof.\ L.\ Connor \quad Dr.\ Barone}
...
\begin{columns}
  ...
  \block{Acknowledgements}{
    ...
    $|$ Harvard \& Smithsonian. Supported by the Harvard College Research
    Program (HCRP).
  ...
  \block{Abstract}{
    ...
    gravitational lenses in Euclid surveys, the first wide-area
    space-based optical survey. Building on POLISH
    \parencite{Connor2022} and POLISH++ \parencite{Wu2026}, originally
    developed for radio astronomy, we increase the resolution of Euclid images
    to the level of higher-quality Hubble images, training on synthetic
  ...
  \block{Background}{
    ...
    \begin{minipage}[c]{0.50\linewidth}
      ...
      survey resolution the arcs blend into the lens light --- the systems
      that best constrain dark-matter halos are exactly the ones wide
      surveys miss.
    \end{minipage}\hfill
  ...
  \block{Model Architecture}{
    WDSR-A (POLISH/POLISH++): a deep CNN with
    32 wide-activation residual blocks ($\times6$ channel expansion),
    99 weight-normalised convolutions, a global residual
  ...
  \block{Preliminary Results: Euclid vs.\ SR vs.\ Hubble}{
    % 2x2 grid: text | Euclid LR // Hubble HR | our SR. Plain minipages —
    % center/tikzfigure environments misbehave inside tikzposter blocks.
    \begin{minipage}[c]{0.48\linewidth}
      One real galaxy, three views: the Euclid input, the Hubble image of
      the same target, and our super-resolved reconstruction. The model
      both super-resolves and denoises, recovering structure that is
      blurred or buried in the original.
    \end{minipage}\hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[width=\linewidth]{fig/poster/result_euclid.png}\\[2pt]
      {\small Euclid VIS (0.10$''$/pix)}
    \end{minipage}
    \par\vspace{4mm}
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \includegraphics[width=\linewidth]{fig/poster/result_hubble.png}\\[2pt]
      {\small Hubble WFPC2 F814W (0.046$''$/pix)}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\linewidth}
      \centering
      \includegraphics[width=\linewidth]{fig/poster/result_sr.png}\\[2pt]
      {\small Super-resolved (ours, 0.05$''$/pix)}
    \end{minipage}
  }
