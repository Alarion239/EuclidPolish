...
\begin{columns}
  ...
  \block{Preliminary Results: Euclid vs.\ SR vs.\ Hubble}{
    One real galaxy, three views: the Euclid input, the Hubble image of the
    same target, and our super-resolved reconstruction. The model both
    super-resolves and denoises, recovering structure that is blurred or
