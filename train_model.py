...
def main(images_dir, caches_dir, fnoutweights, ntrain=800, nvalid=100,
    ...
    trainer = Trainer(model=wdsr(scale=scale, num_res_blocks=num_res_blocks, nchan=nchan),
...
if __name__=='__main__':
    ...
    parser.add_option("--train_steps", dest="train_steps", type=int, default=100000,
