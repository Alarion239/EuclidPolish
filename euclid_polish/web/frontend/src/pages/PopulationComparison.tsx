...
import {
  Badge, Button, Card, CardBody, CardHead, Checkbox, Empty, Page,
          ...
          <section className="comparison-section comparison-section--population">
            <header className="comparison-section__head">
              <div>
                ...
                <p>What is in the generated fields. Survey population fits live on Galaxy distributions and Star distributions.</p>
              </div>
            ...
            {includeTraining && (
              <p className="calibration-plain-note">
                Training truth is included in this census only; image and source
                diagnostics otherwise remain on test + validation records.
              </p>
            )}
            ...
            <p className="population-census-note">
              Euclid MER + PHZ magnitude and radius statistics are queried and fitted on
              Galaxy distributions; stellar counts and colours are reviewed on Star distributions.
            </p>
