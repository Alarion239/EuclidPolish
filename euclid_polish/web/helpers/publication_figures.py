...
def render_population_atlas(
    ...
    with presentation_rc(style):
        ...
        _line(
            ...
            label="Q1 2FWHM fitted main law",
            width=2.7,
        )
        _line(
            axes[0], generation_law, "density", color="#168f65",
            label="generation law: continuous bright bridge + main + flat",
            width=3.0,
        )
        ...
        if radius_x.size:
            axes[1].plot(
                ...
                markersize=4.6, markerfacecolor=PAPER,
                markeredgecolor=EUCLID_OBS, markeredgewidth=1.2,
                label="Euclid PHZ/MER cleaned circularized Sérsic $R_e$",
                zorder=4,
            )
        ...
        relation_payload = {
            ...
            "low": relation.get("model_core_low_log10_arcsec") or [],
            "high": relation.get("model_core_high_log10_arcsec") or [],
        }
        ...
        _line(
            ...
            label="straight conditional mean",
            width=2.7,
        )
