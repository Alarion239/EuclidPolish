"""Euclid VIS brightness/radius prior laws for the joint galaxy artifact.

Redshift left this model in v15: synthetic galaxy colours come from the
empirical conditional colour+SFR forest
(:mod:`euclid_polish.population.conditional_color_sfr`) instead of a
per-galaxy redshift draw, so the conditional PHZ redshift distribution that
lived here through v14 was deleted with the version bump.
"""
...
JOINT_EUCLID_GALAXY_VERSION = 15
