...
def test_full_pipeline_round_trip(tmp_path):
    ...
    # 4. Build the training pipeline via Model.
    m = Model(str(tmp_path / "ckpt"), scale=2, num_res_blocks=2)
    ds = m._build_training_pipeline(
